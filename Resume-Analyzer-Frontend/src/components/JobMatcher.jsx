            ...
            <div className={`rounded-xl shadow-sm p-6 ${isDark ? "bg-gray-800" : "bg-white"}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  >
                    These keywords appear in the job description and seem implied by your
                    experience, but aren’t explicitly listed in your resume.
                  </p>

                  <ul className="space-y-2">
                    {matchResult.keywordToAdd &&
                    matchResult.keywordToAdd.length > 0 ? (
                      matchResult.keywordToAdd.map((item, idx) => (
                        <li key={idx} className="flex items-start">
                          <SparklesIcon className="h-5 w-5 text-blue-500 mr-2 mt-0.5 shrink-0" />
