...
// import { getEmail, getName, setPassword, setThemeBackend } from "../services/appServices";
...
// //         <button
// //           className="px-4 py-2 border border-red-300 dark:border-red-500
...
// //     {showSuccessModal && (
// //       <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
// //         <div className="bg-white dark:bg-gray-800 p-6 rounded-xl w-96 text-center space-y-4">
