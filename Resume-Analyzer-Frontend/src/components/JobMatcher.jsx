...
function JobMatcher() {
    ...
    const recentJobs = [
        { id: 1, title: 'Senior Frontend Developer', company: 'TechCorp', match: 92, date: '2 days ago' },
        { id: 2, title: 'Full Stack Engineer', company: 'StartupXYZ', match: 85, date: '1 week ago' },
        { id: 3, title: 'React Developer', company: 'Innovate Inc', match: 78, date: '2 weeks ago' },
    ];
    ...
    //                     className="block w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
    //                   />
    //                 </div>
    //                 <button
    //                   onClick={analyzeJob}
    //                   disabled={loading || !selectedResume || !jobDescription.trim()}
    //                   className="px-6 py-3 bg-blue-600 text-white rounded-r-lg disabled:opacity-50"
    //                 >
    //                   {loading ? (
    //                     <>
    ...
    //                         getScoreColor(matchResult.score).split(" ")[0]
    //                       }`}
    //                     >
    //                       {matchResult.score}%
    //                     </span>
    //                     <span className="text-gray-600 mt-2">Match Score</span>
    //                   </div>
    //                 </div>
    //                 <div
    //                   className={`mt-4 px-4 py-2 rounded-full text-sm font-medium ${getScoreColor(
    //                     matchResult.score
    //                   )}`}
    //                 >
    ...
    //               {/* Recommendations */}
    //               {matchResult.suggestions.length > 0 && (
    //                 <div className="mt-6 border border-blue-200 rounded-xl p-5 bg-blue-50">
    //                   <div className="flex items-center mb-4">
    ...
    //                       <li key={idx} className="flex items-start">
    //                         <div className="mr-3 mt-1 w-2 h-2 rounded-full bg-blue-500" />
    ...
    //                 <button className="px-5 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700">
    //                   Save Analysis
    //                 </button>
    ...
    //                 </div>
    //               ))}
    //               <button className="w-full mt-2 px-4 py-2 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50">
    //                 View All Analyses
    //               </button>
    //             </div>
    //           </div>
    ...
    //           {/* Tips Card */}
    //           <div className="bg-linear-to-br from-blue-50 to-indigo-50 rounded-xl shadow-sm p-6 border border-blue-100">
    //             <h3 className="text-lg font-semibold text-gray-900 mb-4">
    ...
    //                   Update your resume with specific skills mentioned in job
    //                   descriptions
    //                 </span>
    //               </li>
    //               <li className="flex items-start">
            ...
            <div className="space-y-4">
              <div className="flex">
                ...
                <button
                  onClick={analyzeJob}
                  disabled={loading || !selectedResume || !jobDescription.trim()}
                  className="px-6 py-3 bg-blue-600 text-white rounded-r-lg disabled:opacity-50 hover:bg-blue-700"
                >
                  {loading ? (
                    <>
                      <ArrowPathIcon className="h-5 w-5 mr-2 animate-spin" />
          ...
          (matchResult.score > 0 ||
            ...
            <div className={`rounded-xl shadow-sm p-6 ${isDark ? "bg-gray-800" : "bg-white"}`}>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <button className={`px-5 py-2.5 border font-medium rounded-lg ${
                  isDark 
        ...
        <div className="space-y-8">
          ...
          {/* <div className={`rounded-xl shadow-sm p-6 ${isDark ? "bg-gray-800" : "bg-white"}`}>
            ...
            <div className="space-y-4">
              <div className={`flex items-center justify-between p-3 rounded-lg ${
                ...
                <span className={`text-2xl font-bold ${isDark ? "text-white" : "text-gray-900"}`}>12</span>
              </div>
              <div className={`flex items-center justify-between p-3 rounded-lg ${
              ...
              <div className={`flex items-center justify-between p-3 rounded-lg ${
                ...
                <div className="flex items-center">
                  <ChartBarIcon className="h-5 w-5 text-purple-600 mr-3" />
                  <span className={isDark ? "text-gray-300" : "text-gray-700"}>Applications Sent</span>
                </div>
                <span className={`text-2xl font-bold ${isDark ? "text-white" : "text-gray-900"}`}>8</span>
              </div>
            </div>
          </div> */}
          ...
          {/* <div className={`rounded-xl shadow-sm p-6 ${isDark ? "bg-gray-800" : "bg-white"}`}>
            ...
            <div className="space-y-4">
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <p className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}>{job.company}</p>
                    </div>
                    <div
                      className={`px-3 py-1 rounded-full text-sm font-medium ${getScoreColor(job.match, isDark)}`}
                    >
                      {job.match}%
                    </div>
                  </div>
              ...
              <button className={`w-full mt-2 px-4 py-2 border font-medium rounded-lg ${
                isDark 
                  ? "border-gray-600 text-gray-300 hover:bg-gray-700" 
                  : "border-gray-300 text-gray-700 hover:bg-gray-50"
              }`}>
...
//                 onChange={(e) => setJobDescription(e.target.value)}
//                 placeholder="Paste the full job description here..."
//                 className={`flex-1 p-4 border rounded-l-lg focus:ring-2 focus:ring-blue-500 ${
//                   isDark
...
//                 onClick={analyzeJob}
//                 disabled={loading || !selectedResume || !jobDescription.trim()}
//                 className="px-6 bg-blue-600 text-white rounded-r-lg disabled:opacity-50"
//               >
...
//                   getScoreColor(matchResult.score)
//                 }`}>
//                   {matchResult.score}%
//                 </span>
//                 <span className={`mt-2 ${
