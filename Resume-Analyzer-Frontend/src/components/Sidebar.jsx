...
//   { text: 'Job Matches', icon: <BriefcaseIcon className="h-5 w-5" />, path: '/jobmatcher' },
//   { text: 'Applications', icon: <ChartBarIcon className="h-5 w-5" />, path: '/applications' },
//   { text: 'Interview Prep', icon: <ChatBubbleLeftRightIcon className="h-5 w-5" />, path: '/interview' },
...
//   const desktopClasses = "hidden lg:block fixed inset-y-0 z-40 w-64 border-r border-gray-200";
...
//                       ({ isActive }) => isActive ? 'text-blue-600' : 'text-gray-400'
//                     }`}>
//                       {item.icon}
//                     </span>
//                     {item.text}
...
//         />
//         {/* Sidebar Panel */}
//         <div className="fixed inset-y-0 left-0 flex w-64 max-w-xs flex-col">
//           {sidebarContent}
//         </div>
//       </div>
//     );
