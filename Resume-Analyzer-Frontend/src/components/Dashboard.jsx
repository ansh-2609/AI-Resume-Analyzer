      ...
      >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              <div
                className={`flex items-center p-3 rounded-lg ${isDark ? "hover:bg-gray-700/50" : "hover:bg-gray-50"}`}
              >
                <div
                  className={`p-2 rounded-full ${isDark ? "bg-green-900/30" : "bg-green-100"}`}
                >
                  <CheckCircleIcon className="h-5 w-5 text-green-600" />
                </div>
                <div className="ml-4">
              ...
              >
                <div
                  className={`p-2 rounded-full ${isDark ? "bg-blue-900/30" : "bg-blue-100"}`}
                >
                  <ArrowPathIcon className="h-5 w-5 text-blue-600" />
                </div>
                <div className="ml-4">
...
//           {
//             label: "Resume Score",
//             value: resume || selectedResume ? metadata.score : "--",
//             icon: DocumentTextIcon,
//             bg: "blue",
//           },
//           {
//             label: "Strengths",
//             value: metadata.strengths?.length || 0,
//             icon: CheckCircleIcon,
//             bg: "green",
//           },
//           {
//             label: "Weaknesses",
//             value: metadata.weaknesses?.length || 0,
//             icon: CheckCircleIcon,
//             bg: "red",
//           },
//           {
//             label: "Improvements",
//             value: metadata.improvements?.length || 0,
//             icon: ArrowPathIcon,
//             bg: "blue",
//           },
...
//                 }`}
//               >
//                 <Icon className={`h-6 w-6 text-${bg}-600`} />
//               </div>
//               <div className="ml-4">
...
//             <label className="mt-6 inline-flex px-4 py-2 rounded-md text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 cursor-pointer">
//               Browse Files
//               <input
//                 type="file"
//                 accept=".pdf,.doc,.docx"
...
//             <label className="mt-6 inline-flex items-center justify-center px-4 py-2 rounded-md text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 cursor-pointer">
//               Browse Files
//               <input
//                 type="file"
//                 accept=".pdf,.doc,.docx"
