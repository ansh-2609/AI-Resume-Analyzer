...
const isDark = theme === "dark";
  ...
  //             </p>
  //           </div>
  //           <div className="flex items-center space-x-2 px-4 py-2 bg-linear-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
  ...
  //                   className="px-4 py-2 border border-gray-300 rounded-md text-sm text-black cursor-pointer"
  //                 >
  //                   Download
  //                 </button>
  ...
  //               <div className="flex items-center justify-between p-3 bg-linear-to-r from-purple-50 to-violet-50 rounded-lg">
  //                 <div className="flex items-center">
  //                   <FireIconSolid className="h-5 w-5 text-purple-600 mr-3" />
  //                   <span className="text-gray-700">High Matches (8+)</span>
  //                 </div>
  //                 <span className="text-2xl font-bold text-gray-900">
  //                   {stats.highMatch}
  //                 </span>
  ...
  //                   <span
  //                     key={index}
  //                     className="px-3 py-1 bg-linear-to-r from-blue-100 to-indigo-100 text-blue-700 text-xs font-medium rounded-full"
  //                   >
  //                     {skill}
  //                   </span>
  //                 ))}
  ...
  //                             </h3>
  //                             {job.score >= 8 && (
  //                               <span className="flex items-center px-2 py-1 bg-linear-to-r from-green-100 to-emerald-100 text-green-800 text-xs font-medium rounded-full">
  ...
  //                         {/* Recommendations */}
  //                         <div className="mt-6 p-4 bg-linear-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
  ...
  //                   {/* Showing 1-{Math.min(10, sortedJobs.length)} of {sortedJobs.length} jobs */}
  ...
  //                     1
  //                   </button>
  //                   {/* <button className="px-3 py-2 border border-blue-600 bg-blue-50 text-blue-600 rounded-lg text-sm font-medium">
  //                     2
  //                   </button> */}
  //                   <button
  //                     className={`px-3 py-2 border  rounded-lg text-sm font-medium hover:bg-gray-50 ${
  ...
  //           {/* Tips Card */}
  //           <div className="mt-6 bg-linear-to-r from-purple-50 to-pink-50 rounded-xl shadow-sm p-6 border border-purple-100">
  //             <h3 className="text-lg font-semibold text-gray-900 mb-4">
  ...
  //                   Apply within 48 hours of job posting for better response
  //                   rates
  //                 </span>
  //               </div>
  //               <div className="flex items-start">
  ...
  //                 </div>
  //                 <span className="text-sm text-gray-700">
  //                   Tailor your resume to include keywords from each job
  //                   description
  //                 </span>
  //               </div>
  //               <div className="flex items-start">
  ...
  //                 </div>
  //                 <span className="text-sm text-gray-700">
  //                   Focus on roles with 80%+ match score for highest success
  //                   rate
  //                 </span>
  //               </div>
  //               <div className="flex items-start">
...
//           <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
//             <div>
//               <h1 className={`text-3xl font-bold ${isDark ? "text-gray-100" : "text-gray-900"}`}>Matched Jobs</h1>
//               <p className="mt-2 text-gray-600">
//                 Discover opportunities that match your resume
//               </p>
//             </div>
